            ...
            <div>
                <Dialog className="bp3-dark"
                    ...
                    <div data-element-id='warning-dialog'
                         ...
                         <a data-element-id='user-agreement-link'
                            className={Classes.DIALOG_BODY}
                            onClick={()=>{this.mainStore.hideWarningDialog();this.mainStore.showUserAgreement();}}>{link}</a>
                    </div>
        ...
        return (
            <div>
                <Dialog className="bp3-dark"
                    ...
                    <div data-element-id='user-agreement-dialog'
                         className={classNames(Styles.agreement, Classes.DIALOG_BODY)}
                         dangerouslySetInnerHTML={{ __html: content }}/>
                         </div>
                    <div className={Classes.DIALOG_FOOTER}>
                        <div className={Classes.DIALOG_FOOTER_ACTIONS}>
                            <Button data-element-id='back-button'
                                    onClick={()=>{this.mainStore.hideUserAgreement();this.mainStore.showWarningDialog();}}
                                    intent={Intent.SUCCESS}
                                    rightIcon={buttonIcon}>
                                {buttonText}
                            </Button>
