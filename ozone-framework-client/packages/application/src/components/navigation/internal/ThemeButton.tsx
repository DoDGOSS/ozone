...
const _ThemeButton: React.FC = () => {
    useHotkey({ combo: Hotkey.toggleTheme, onKeyDown: mainStore.toggleTheme });

    return (
        <NavbarTooltip title="Theme" shortcut={Hotkey.toggleTheme} description="Toggle between light and dark themes.">
