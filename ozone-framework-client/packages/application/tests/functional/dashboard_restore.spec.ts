...
import { GlobalElements, MainPage, StackDialog, DashboardAdminWidget } from "./selectors";
...
module.exports = {
    "As an Administrator, I can restore a shared Dashboard": (browser: NightwatchAPI) => {
        ...
        browser
            .click(StackDialog.getAddDashboardButtonForStack(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .pause(500)
        ...
        browser.waitForElementVisible(
            StackDialog.getRestoreButtonForDashboard(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Dashboard Dialog] restore button is visible."
        );

        browser
            .click(StackDialog.getRestoreButtonForDashboard(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .waitForElementVisible(
        ...
        browser.getAttribute(DashboardAdminWidget.ADD_USER_BUTTON, "enabled", function(result) {
    ...
    "As a User, I can restore a shared Dashboard": (browser: NightwatchAPI) => {
        ...
        browser.waitForElementVisible(
            StackDialog.getActionButtonsForStack(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
        ...
        browser
            ...
            .waitForElementVisible(
                StackDialog.getActionButtonsForDashboard(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
                2000,
    ...
    "As an Administrator, I want to delete the shared Dashboard": (browser: NightwatchAPI) => {
        ...
        browser
            .click(MainPage.STACKS_BUTTON)
            .waitForElementVisible(
                StackDialog.getDeleteButtonForStack(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
                2000,
        ...
        browser
            .pause(500)
            .click(StackDialog.getDeleteButtonForStack(DashboardAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .waitForElementPresent(
                GlobalElements.CONFIRMATION_DIALOG_CONFIRM_BUTTON,
                1000,
                undefined,
