...
import { GlobalElements, MainPage, StackAdminWidget, StackDialog } from "./selectors";
...
module.exports = {
    "As an Administrator, I can restore a shared Stack": (browser: NightwatchAPI) => {
        ...
        browser.setValue(StackDialog.CreateStack.NAME_FIELD, StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME);
        ...
        browser
            ...
            .waitForElementVisible(
                StackDialog.getAddDashboardButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
                2000,
                "[Stack Dialog] Add dashboard button is visible"
            );

        browser
            .click(StackDialog.getAddDashboardButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .pause(500)
            .waitForElementVisible(
        ...
        browser.waitForElementVisible(
            StackDialog.getRestoreButtonForDashboard(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Stack Dialog] restore button is visible."
        );

        browser
            .click(StackDialog.getRestoreButtonForDashboard(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .waitForElementVisible(
        ...
        browser.waitForElementVisible(
            StackDialog.getRestoreButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Stack Dialog] restore button is visible."
        );

        browser
            .click(StackDialog.getRestoreButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .waitForElementVisible(
                GlobalElements.CONFIRMATION_DIALOG_CONFIRM_BUTTON,
                2000,
                "[Confirmation Dialog] is visible"
        ...
        browser.waitForElementVisible(
            StackDialog.getShareButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Stack Dialog] share button is visible."
        );

        browser
            .click(StackDialog.getShareButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
        ...
        browser.waitForElementVisible(
            StackAdminWidget.dashboardTableEditButton(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Dashboard Admin Widget Edit Button] is visible."
        );

        browser.click(StackAdminWidget.dashboardTableEditButton(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME));

        browser.waitForElementVisible(
            StackAdminWidget.USERS_TAB,
            2000,
    ...
    "As a User, I can restore a shared Stack": (browser: NightwatchAPI) => {
        ...
        browser.waitForElementVisible(
            StackDialog.getActionButtonsForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
            2000,
            "[Stack Dialog] Stack is visible."
        );
        browser
            .waitForElementVisible(StackDialog.STACK_LIST, 2000, "[Dashboard list] is visible")
            .click(StackDialog.STACK_LIST)
            .waitForElementVisible(
                StackDialog.getActionButtonsForDashboard(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
                2000,
    ...
    "As an Administrator, I want to delete the shared Stack": (browser: NightwatchAPI) => {
        loggedInAs(browser, "testAdmin1", "password", "Test Administrator 1");
        ...
        browser
            .click(MainPage.STACKS_BUTTON)
            .waitForElementVisible(
                StackDialog.getDeleteButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME),
                2000,
        ...
        browser
            .pause(500)
            .click(StackDialog.getDeleteButtonForStack(StackAdminWidget.DASHBOARD_ADMIN_TEST_DASHBOARD_NAME))
            .waitForElementPresent(
                GlobalElements.CONFIRMATION_DIALOG_CONFIRM_BUTTON,
                1000,
                undefined,
