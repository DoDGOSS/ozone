...
Included within the OWF bundle `{path-ozone-security}/` is the default `security.xml` Spring configuration file, as well as additional example configurations files.
