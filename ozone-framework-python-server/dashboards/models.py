...
class Dashboard(models.Model):
    ...
    user = models.ForeignKey('people.Person', models.DO_NOTHING, blank=True, null=True, related_name='dashboard_user')
    description = models.CharField(max_length=4000, blank=True, null=True)
    created_by = models.ForeignKey('people.Person', models.DO_NOTHING, blank=True, null=True, related_name='dashboard_created_by')
    created_date = models.DateTimeField(blank=True, null=True)
    edited_by = models.ForeignKey('people.Person', models.DO_NOTHING, blank=True, null=True, related_name='dashboard_edited_by')
    edited_date = models.DateTimeField(blank=True, null=True)
    layout_config = models.TextField(blank=True, null=True)
    locked = models.BooleanField(blank=True, null=True)
    stack = models.ForeignKey('stacks.Stack', models.DO_NOTHING, blank=True, null=True)
