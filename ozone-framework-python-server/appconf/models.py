...
class ApplicationConfiguration(models.Model):
    ...
    created_by = models.ForeignKey('people.Person', on_delete=models.SET_NULL, blank=True, null=True, related_name='appconf_created_by')
    created_date = models.DateField(default=datetime.now, blank=True, null=True)
    edited_by = models.ForeignKey('people.Person', on_delete=models.SET_NULL, blank=True, null=True, related_name='appconf_edited_by')
    edited_date = models.DateField(default=datetime.now, blank=True, null=True)
