    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prev_login', models.DateTimeField(default=django.utils.timezone.now, null=True)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('last_notification', models.DateTimeField(default=django.utils.timezone.now, null=True)),
