...
class PersonCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Person
        fields = ('email', 'username', 'user_real_name')
...
class PersonChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Person
        fields = ('email', 'password', 'username', 'user_real_name', 'is_active', 'is_admin')
...
class PersonAdmin(BaseUserAdmin):
    ...
    list_display = ('id', 'email', 'username', 'is_admin', 'requires_sync')
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'username', 'user_real_name', 'password1', 'password2')}
         ),
    )
    search_fields = ('email',)
    ordering = ('email',)
